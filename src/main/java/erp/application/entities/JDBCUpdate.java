...
public class JDBCUpdate {
	...
	private static void insertIntoUserRole(String [] listOfKeys) {
		System.out.println(listOfKeys[0] + " " + listOfKeys[1] + " " + listOfKeys[listOfKeys.length-2] + " " + listOfKeys[listOfKeys.length-1]);
		final String sqlInsert = "INSERT INTO user_role (user_id, role_id) VALUES ('" + listOfKeys[listOfKeys.length-2] + "', '" + listOfKeys[listOfKeys.length-1] +"')";
