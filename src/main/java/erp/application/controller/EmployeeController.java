...
public class EmployeeController {
	...
	public EmployeeController(ProductsRepository empRepo) {
	...
	public Products addEmployee(@PathVariable("id") final Integer id, @PathVariable("cnp")final String cnp, @PathVariable("work_contract")final String work_contract, @PathVariable("employee_name")final String employee_name, 
		...
		employeeRepository.save(new Products(id, cnp, work_contract, employee_name, employee_salary, bank_account));
	...
	@ResponseBody
	public Products updateEmployee(@PathVariable("id") final Integer id, @PathVariable("cnp") final String cnp, @PathVariable("work_contract") final String work_contract, 
		...
		employeeRepository.update(new Products(id, cnp, work_contract, employee_name, employee_salary, bank_account));
		return employeeRepository.findById(id);
	}
	
	@DeleteMapping(value="/deleteEmployee/{id}")
	@ResponseBody
	public Map<String, Products> deleteEmployee(@PathVariable(value="id") final String i){
		int id = 0;
		try {
	...
	@ResponseBody
	public Map<String, Products> allEmployees(){
